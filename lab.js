...
let kitty = new Cat('Arnold',1,'white')
console.log(kitty)
//Code here
...
let wizard1 = new Wizard('Merlin',1000,'Doom')
wizard1.castSpell();
...
//Code Here
let phone1 = new Phone('Samsung','Fold',128,'Black',10000)
let phone2 = new Phone('Iphone','XR',256,'Red',90000)
let phone3 = new Phone('Google','Pixel',128,'Silver',500)
/* 
...
class Vehicle {
  ...
  move(miles){
    this.mileage += miles
    console.log(`you have traveled ${this.mileage}`)
  }
}
...
*/
let myFirstVehicle = new Vehicle('Green', 7, 200000)
//Code Here
...
//Code Here 
let myFirstMotorcycle = new Motorcycle ('2012','False It is Totally AWESOME!')
...
*/
let myFirstBoat = new Boat('irish shanty','sailboat',false)
//Code Here
